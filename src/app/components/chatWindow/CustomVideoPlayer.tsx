...
const CustomVideoPlayer: React.FC<CustomVideoPlayerProps> = ({
  ...
  const handleProgress = (videoRef: React.RefObject<HTMLVideoElement>, setProgressState: React.Dispatch<React.SetStateAction<number>>) => {
    const video = videoRef.current;
    ...
    <>
      ...
      <div className="relative w-full max-w-md sm:max-w-lg md:max-w-xl lg:max-w-2xl group">
        ...
        <div className="absolute bottom-0 left-0 w-full h-1 bg-gray-700 rounded-b-lg overflow-hidden">
          <div className="h-full bg-gradient-to-r from-blue-500 to-blue-300 transition-all" style={{ width: `${progress}%` }} />
        </div>
      </div>
