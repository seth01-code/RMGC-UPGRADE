...
const GigPage: React.FC = () => {
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <button
                    ...
                    className="mt-2 px-4 py-2 rounded-lg border text-blue-500 hover:bg-blue-50 flex items-center gap-2"
                  >
  ...
  "
        >
          ...
          {/* Short Description */}
          <p className="text-gray-600 break-words whitespace-pre-line text-sm leading-relaxed">
            {data.shortDesc}
          </p>
